        ...
        <div class="page">
            ...
            <form class="join j-join">
                ...
                <div class="join__body">
                    <div class="join__row">
                        <input type="text" class="join__input inbg" value="admin" name="username" placeholder="Username" autofocus required title="Field should contain alphanumeric characters only in a range 3 to 20. The first character must be a letter." pattern="^[a-zA-Z][\w]{2,19}$" readonly>
                    </div>

                    <div class="join__row d-none">
                        <input type="text" class="join__input j-join__login" value="admin" name="login" placeholder="login" required title="Field should contain alphanumeric characters only in a range 3 to 20. The first character must be a letter." pattern="^[a-zA-Z][\w]{2,19}$">
                    </div>
            ...
            <div class="container dashboard j-dashboard">
...
<audio id="endCallSignal" preload="auto">
    <source src="<?php echo base_url(); ?>/assets/webrtc/audio/end_of_call.ogg" type="audio/ogg" />
    <source src="<?php echo base_url(); ?>/assets/webrtc/audio/end_of_call.mp3" type="audio/mp3" />
</audio>

<audio id="callingSignal" loop preload="auto">
    <source src="<?php echo base_url(); ?>/assets/webrtc/audio/calling.ogg" type="audio/ogg" />
    <source src="<?php echo base_url(); ?>/assets/webrtc/audio/calling.mp3" type="audio/mp3" />
</audio>

<audio id="ringtoneSignal" loop preload="auto">
    <source src="<?php echo base_url(); ?>/assets/webrtc/audio/ringtone.ogg" type="audio/ogg" />
    <source src="<?php echo base_url(); ?>/assets/webrtc/audio/ringtone.mp3" type="audio/mp3" />
</audio>
