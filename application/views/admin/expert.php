            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <div>
                            <select class="form-control text-paragraph" id="poex1" required="">
                                <option selected="">--- กรุณาเลือก ---</option>
                            </select>
...
<div class="main-margin padding_main">
    <div class="padding_main bgWhite mainBoxRadius boxHeader">
        ...
        <div>
            <button class="btn_backend text_btn btn" id="btnInsert" data-toggle="modal" data-target="#insertExpert"><i class="fa fa-plus"></i>&nbsp;&nbsp;เพิ่มผู้เชี่ยวชาญ</button>
        </div>
    </div>
    <div class="bgWhite padding_main mainBoxRadius">
        <div class="row">
            <div class="col-md-3 main-margin" style="text-align: center;">
                <div class="cardUser cardBox main-margin" style="cursor: pointer;" data-toggle="modal" data-target="#editExpert">
        ...
        <!-- <div style="overflow-x:auto;">
            <table>
                <tr>
                    ...
                    <th class="th_text">ผู้เชี่ยวชาญ</th>
                    <th class="th_text">ประเภทผู้เชี่ยวชาญ</th>
                ...
                <tr>
                    ...
                    <td class="td_text">
                        <button class="btn btn-success" data-toggle="modal" data-target="#editExpert">
